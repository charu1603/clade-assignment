...
const Sidebar = () => {
  return (
    <aside className="p-6 bg-[#FCFCFC] border-tl border-gray-300 text-xs font-medium">
      <div className="mb-4 flex justify-between space-x-4">
        <button className="border-red-500 border text-red-600 font-medium bg-red-50 text-xs  py-2 px-4 rounded-md w-full flex items-center justify-center"><span className='text-lg'><MdOutlineDeleteOutline /></span>  Delete Job</button>
        <button className="bg-red-500 text-white border-2 border-red-100 font-medium text-xs py-2 px-4 rounded-md w-full flex items-center justify-center"><span className='text-md'><FiEdit2 /></span> Edit Job</button>
      </div>
      <div className="">
