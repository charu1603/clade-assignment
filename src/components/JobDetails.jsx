...
const JobDetails = () => {
  return (
    <section className="py-6 bg-white border border-gray-300 text-sm ">
     ...
     <span className="ml-4 text-gray-500 text-xs mt-2">posted 2 days ago</span>
        <div className=" flex items-center justify-center"><button className='text-[10px] font-medium relative'><span className="absolute top-[35%] left-1 bg-green-500 text-white text-xs rounded-full w-1 h-1 flex items-center justify-center"></span><span className='bg-green-100 px-2 rounded-full border border-green-300 text-green-600 '>Open</span></button></div>
        </div>
         ...
         <div className=''>
           <h6 className='font-medium text-gray-500 '>Skills required</h6>
            <div className='flex flex-col pt-2 space-y-2 text-[10px]'>
                <span className='flex items-center'><p className=' rounded-[5px] border border-gray-300 flex items-center mr-2 px-1'><img src={figma} className='w-3 h-3 pr-1'></img>Figma</p></span>
                <span  className='flex items-center'><p className=' rounded-[5px] border border-gray-300 flex items-center mr-2 px-1'><img src={logo4} className='w-3 h-3 pr-1 '></img>Adobe Illustrator</p></span>
                <span className='flex items-center'><p className=' rounded-[5px] border border-gray-300 flex items-center mr-2 px-1'><img src={logo3} className='w-3 h-3 pr-1'></img>Adobe XD</p></span>
      ...
      <div className="text-xs  mb-2 text-gray-500 pt-4">About the job</div>
      <ol className="list-decimal pl-3 mb-2 font-medium">
      ...
      <ul className="list-disc pl-4 mb-2 font-medium text-xs">
